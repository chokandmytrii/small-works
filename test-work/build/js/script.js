...
var moneyValue = {};
var ratesNow = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var obj, currentRates, result, USD, resultEURfirst, EUR, resultUSD, resultEUR, ratesList;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 2:
            ...
            return obj.json();
          case 5:
            currentRates = _context.sent;
            result = currentRates.rates;
            USD = currencyRound(result.UAH);
            resultEURfirst = result.UAH * result.EUR;
            EUR = currencyRound(resultEURfirst);
            resultUSD = returningMsg(USD, 'USD');
            resultEUR = returningMsg(EUR, 'EUR');
            moneyValue['USD'] = USD;
            moneyValue['EUR'] = EUR;
            ratesList = document.querySelectorAll(".header__rate");
            ratesList[0].innerHTML = resultEUR;
            ratesList[1].innerHTML = resultUSD;
            return _context.abrupt("return", moneyValue);
          case 18:
          case "end":
...
function returningMsg(currencyVal, currency) {
  var msg = "".concat(currency, " worth now <span class=\"").concat(currency, "\">").concat(currencyVal, "</span> Ukrainian Hrivnas");
  return msg;
}
/* harmony default export */ __webpack_exports__["default"] = (ratesNow);
...
/* harmony default export */ __webpack_exports__["default"] = (createElem);
...
var form = new vue_dist_vue_esm_browser__WEBPACK_IMPORTED_MODULE_0__["default"]({
  el: '#form',
  data: {
    dollar: '',
    euro: '',
  ...
  methods: {
    ...
    roundResult: function roundResult(value1, value2, multiplier, action) {
      var countingResult;
      if (action === "*") {
      ...
      var result = Math.round(countingResult * multiplier) / multiplier;
      return result;
    },
  ...
  computed: {
    countMulti: function countMulti() {
      this.counting();
    }
  },
  mounted: function mounted() {
    var _this = this;
    Object(_api__WEBPACK_IMPORTED_MODULE_1__["default"])().then(function (result) {
      _this.dollar = result.USD;
      _this.euro = result.EUR;
    });
  },
  watch: {
    ...
    currency1: function currency1() {
      this.counting();
      this.result1 = this.roundResult(this.result2, this.multiplier, 100, "*");
    },
    currency2: function currency2() {
      this.counting();
      this.result2 = this.roundResult(this.result1, this.multiplier, 100, "/");
    }
  }
...
/***/ 0:
/*!**************************************************************************************!*\
  !*** multi ./src/js/api.js ./src/js/createEl.js ./src/js/form.js ./src/js/script.js ***!
  \**************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

__webpack_require__(/*! C:\Users\Dmytrii\Desktop\works\test-work\src\js\api.js */"./src/js/api.js");
__webpack_require__(/*! C:\Users\Dmytrii\Desktop\works\test-work\src\js\createEl.js */"./src/js/createEl.js");
__webpack_require__(/*! C:\Users\Dmytrii\Desktop\works\test-work\src\js\form.js */"./src/js/form.js");
module.exports = __webpack_require__(/*! C:\Users\Dmytrii\Desktop\works\test-work\src\js\script.js */"./src/js/script.js");
