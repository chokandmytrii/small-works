...
/* harmony import */ var _createEl__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(/*! ./createEl */ "./src/js/createEl.js");
...
function addClass(node, classList) {
  ...
  (_node$classList = node.classList).add.apply(_node$classList, _toConsumableArray(classList.split(' ')));
}
...
// fetch('https://api.sampleapis.com/coffee/hot', options)
...
// fetch('http://openlibrary.org/subjects/love.json', options)
//     .then(response => response.json())
...
var bookResult = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var obj, result, books, finResult, htmlFull, htmlTitle, htmlAuthor, htmlCoverId, htmlAdd;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return fetch("http://openlibrary.org/subjects/".concat(subject, ".json?limit=24"));
          case 2:
            obj = _context.sent;
            _context.next = 5;
            return obj.json();
          case 5:
            ...
            finResult = result.works;
            console.log(finResult);
            books = document.querySelector(".bookshell__table");
            htmlFull = [];
            htmlTitle = '';
            htmlAuthor = '';
            finResult.forEach(function (element) {
              ...
              htmlObj['title'] = htmlTitle;
              author.forEach(function (element) {
                console.log(element.name);
                return htmlAuthor = "by ".concat(element.name);
              });
              htmlObj['author'] = htmlAuthor;
              htmlCoverId = element.cover_id;
              htmlObj['cover'] = htmlCoverId;
              htmlFull.push(htmlObj);
            });
            console.log(htmlFull);
            htmlFull.forEach(function (element) {
              htmlAdd = createElem({
                tagName: 'li',
                classList: 'bookshell__element',
                content: [createElem({
                  tagName: 'img',
                  classList: 'bookshell__element__img',
                  atributes: {
                    src: "https://covers.openlibrary.org/b/id/".concat(element.cover, "-M.jpg"),
                    alt: element.title
                  }
                }), createElem({
                  tagName: 'h2',
                  classList: 'bookshell__element__title',
                  content: element.title
                }), createElem({
                  tagName: 'p',
                  classList: 'bookshell__element__text',
                  content: element.author
                })]
              });
              books.appendChild(htmlAdd);
              // books.append(htmlTest);
...
var bookshellVm = new vue_dist_vue_esm_browser__WEBPACK_IMPORTED_MODULE_0__["default"]({
  el: '#bookshell',
  data: {}
});
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _createEl__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./createEl */ "./src/js/createEl.js");
/* harmony import */ var _api__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./api */ "./src/js/api.js");
/* harmony import */ var _bookshell__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./bookshell */ "./src/js/bookshell.js");
...
/***/ 0:
/*!*******************************************************************************************!*\
  !*** multi ./src/js/api.js ./src/js/bookshell.js ./src/js/createEl.js ./src/js/script.js ***!
  \*******************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
__webpack_require__(/*! C:\Users\Dmytrii\Desktop\works\shop-one\src\js\createEl.js */"./src/js/createEl.js");
module.exports = __webpack_require__(/*! C:\Users\Dmytrii\Desktop\works\shop-one\src\js\script.js */"./src/js/script.js");
